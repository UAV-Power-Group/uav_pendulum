...
void lidar_cb(const sensor_msgs::LaserScan::ConstPtr& scan)
{
	...
	{	
		...
		else
		{
			...
			for (int i = 0; i < 2; i++)
      			 {
        			vel_sp_body[i] = satfunc(vel_sp_body[i],0.25);
       			 }
